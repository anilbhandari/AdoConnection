<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="AdoConnection.WebForm2" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Load Cache" />
